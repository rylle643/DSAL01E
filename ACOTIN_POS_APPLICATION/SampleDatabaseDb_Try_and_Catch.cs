...
{
    public partial class SampleDatabaseDb_Try_andCatch : Form
    {
        string picpath;
        ...
        public SampleDatabaseDb_Try_andCatch()
        {
            connectionString = "Data Source=C203-34;Initial Catalog=SampleDatabaseDb1; user id=sa; password=B1Admin123@";
        ...
        private void Savebutton_Click(object sender, EventArgs e)
        {
          ...
          + picpathtextBox.Text + "')";
            ...
            {
                MessageBox.Show("Error: Cannot save student record");
                connection.Close();
            }
        }
        ...
        private void Searchbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error: Cannot find student record");
                connection.Close();
            }
        }
        ...
        private void Deletebutton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error: Cannot delete student record");
                connection.Close();
            }
        }
        ...
        private void Editbutton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Error: Cannot update student record");
                connection.Close();
            }
        }
